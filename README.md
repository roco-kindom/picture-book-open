# 洛克图鉴
Kotlin Compose Multiplatform实现的洛克王国图鉴, 遵循谷歌**Material3**设计. 您可以随时同步官网数据.  
...
## 下载体验
+ Release 版本V1.0, 发布时间2026/03/06, 稳定
  - [点击下载 V1.0](https://github.com/roco-kindom/picture-book-open/releases/tag/release_v1.0)
